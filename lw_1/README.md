...
В этой ЛР для визуализации разрешалось использовать произвольное графическое API и UI-framework. Допускалось использовать и веб-технологии (HTML,
CSS, JavaScript), их мы и применили в этой ЛР.

### <a name="_toc95259798"></a>**Обязательные задания**

#### **_Задание 1. 30 баллов_**

Результатом работы является GUI-приложение, отображающее при помощи векторных примитивов (прямоугольники, многоугольники и другие). Ваши инициалы разноцветными
буквами.

##### Бонус 20 баллов за создание анимированного изображения

Доработано приложение так, чтобы мои инициалы (Л.Д.В.) подпрыгивали (равноускоренное движение). Фаза прыжка каждой буквы несколько отличается
от фазы прыжка предыдущей.

#### **_Задание 2 – 60 баллов_**

Я разработал GUI-приложение графическое приложение, визуализирующее с использованием векторных примитивов картинку на тему **Троллейбус**.
Разрешалось выбрать одну из следующих тем:
...
Пользователь может «таскать» картинку при помощи мыши методом drag-and-drop.

### <a name="_toc95259799"></a>**Дополнительные задания**

#### **_Задание 4. 150 баллов_**

Разработать с использованием произвольного графического API и UI-фреймворка компьютерную игру «Виселица».
...
#### **_Клиентская и неклиентская область окна_**
...
#### **_Элементы управления и диалоговые окна_**
...
#### **_Сообщения и очередь сообщений_**
...
Простейший цикл выборки представляет собой цикл _while_, в котором приложение извлекает очередное сообщение из очереди сообщений при помощи
...
#### **_Функция WinMain - точка входа в приложение_**
...
#### **_Шаг 1 – Регистрируем класс главного окна приложения_**
...
#### **_Шаг 2 – Создаем оконную процедуру_**
...
#### **_Шаг 3 – Создаем главное окно приложения_**
...
#### **_Шаг 4 – Показываем главное окно_**
...
#### **_Шаг 5 – Запускаем цикл выборки сообщений_**
...
#### **_Шаг 6 – Собираем все функции воедино_**
...
#### **_Добавляем обработчик сообщения WM_PAINT в оконную процедуру главного окна приложения_**
...
Данный макрос разворачивается в соответствующее case-условие с вызовом макроса HANDLE\_\*, согласно обрабатываемому сообщению.
...
Координаты задаются в логических единицах устройства
...
#### **_Мониторинг количества объектов GDI_**
...
#### **_Работа с объектами GDI с использованием WinAPI_**
...
#### **_Работа с объектами GDI с использованием MFC_**
...
#### **_Работа с объектами GDI с использованием WTL._**
...
#### **_Использование таймера в WinAPI приложениях_**
...
#### **_Использование таймера в WTL-проектах_**
